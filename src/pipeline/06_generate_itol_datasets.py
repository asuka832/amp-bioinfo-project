...
def main():
    ...
    input_fasta = os.path.join(project_root, "family_tree.fasta")
    final_report_csv = os.path.join(project_root, "data", "final_report", "Final_Perfect_Candidates.csv")
    output_dir = os.path.join(project_root, "data", "itol_files")
